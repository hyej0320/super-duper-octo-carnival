...
public class B04_If {
	...
	public static void main(String[] args) {
		...
		if (a < 15) {
			...
			System.out.println("a의 값이 15 이상이고 25보다 작으면 출력");
		} else if (a < 35) {
			System.out.println("a의 값이 15 이상 25 이상이고 35보다 작으면 출력");
		} else {
		...
		// 컴파일러는 여러분이 조건을 잘 짜든 못 짜든 관심이 없다
		...
		System.out.println(num); //변수는 초기화하지 않으면 쓸 수 없다
