...
public class C13_AbstractClass {
	/*
	 	...
	 	- 미완성 메서드를 적어놓고 나중에 상속 받아서 마저 만들어야 하는 클래스
...
//		System.out.println("-------------------------------------");
		...
		harvest(potato2);
		harvest(new Crop() {
			// 인스턴스 블록 - 생성자보다 먼저 생성되는 코드
			// 익명 클래스는 생성자가 없어서 초기화를 사용할 수 없을 때 쓸 수 있는 것이 인스턴스 블록
			// 생성자 보다 먼저 실행되는 코드
			{
				name = "고구마";
				grow();
...
// abstract: 나중에 상속 받으면 구현해야 될 것이 있음
abstract class Crop {
	String name;
	int qty;
