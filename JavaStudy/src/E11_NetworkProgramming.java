...
public class E11_NetworkProgramming {

	/*
		# 자바로 통신 가능한 프로그램 만들기
		
		- 서버소켓은 소켓의 접속을 계속 기다린다
		- 서버소켓에 소켓이 접속되고 나면 양방향으로 통신이 가능하다
		- 서로 원하는 데이터를 전송할 수 있다
		- 상대방에게 내보내는 것이 Output이 되고 상대방으로부터 받는 것이 Input이 된다 
		...
		- 포트번호: 하나의 컴퓨터에서 각 프로그램을 구분하기 위한 용도로 사용되는 번호
		  ※ 현재 컴퓨터에서 열려 있는 포트번호는 cmd -> nestat 명령어로 확인할 수 있다
