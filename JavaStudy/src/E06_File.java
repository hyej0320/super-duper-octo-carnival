...
public class E06_File {
	...
	public static void main(String[] args) {
		...
		// isFile(), isDirectory() : 해당 인스턴스가 파일인지 폴더인지 알 수 있다
		...
		/*
			절대경로: 최초의 위치부터 모든 것을 다 적어놓은 경로
			상대경로: 현재 위치로부터 원하는 파일을 찾아가는 경로
		 ...
		 */
		File ff1 = new File("C:/ai_hj/"
				+ "java-workspace/JavaStudy/myfiles/test.txt");
		File ff2 = new File("myfiles/test.txt");
