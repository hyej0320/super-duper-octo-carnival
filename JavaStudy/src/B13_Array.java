...
public class B13_Array {
	...
	/*
		...
		- 자바의 배열은 변수와는 다르게 선언과 동시에 모든 방이 초기화 되어 있다
	...
	public static void main(String[] args) {
		...
		numbers[4] = 'A'; // 'A': char타입은 2byte로 int타입(4byte)보다 작기 때문에 들어갈 수 있음
		...
		// 값을 한번도 넣은 적 없는 변수에는 0이 자동으로 들어가 있지 않음
//		int a, b, c;
//		
...
//		System.out.println(c);
		...
		double[] avgs = new double[] {
				...
				'김', 4322121232134L, 123456, 3.1234F
		};
				
		// 배열은 그냥 출력하면 내용이 제대로 출력되지 않고 메모리 상의 위치가 출력된다
