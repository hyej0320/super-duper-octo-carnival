...
public class PrizeWheel {
	...
	// boolean타입은 값이 2개라 어떤 상품에 당첨된 지 알려주기는 힘들다
	// boolean[] win = new boolean[360];

	
	// int를 사용하면 뽑았을 때 몇 번째 상품에 당첨된 지 알려줄 수 있다
	int[] win = new int[360];

	
	// n번째 상품 정보는 해당 배열의 n번째에 넣어놓을 예정이다
	...
	public void updateWheel() {
		...
		if(DEBUG_MODE) {
			System.out.println("업데이트 된 확률 배열의 정보");
	...
	/**
	 * 
	 * @return -1: 꽝, -2: 돌림판 당첨되었으나 수량 소진, 그 외: 당첨된 상품 번호
	 */
	public int draw() {
