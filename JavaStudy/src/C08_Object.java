...
public class C08_Object {
	...
	/*
		...
		- Object 클래스의 메서드는 주로 해당 클래스에 맞는 형태로
		  오버라이드하여 사용하게끔 설계되어 있다
		  
		# toString()
		
		- "해당 객체를 문자열로 표현한다면 어떤 모양이어야 하는가"를 정의해두는 메서드
		- 자바의 모든 객체는 toString()을 통해 문자열로 표현될 수 있다
		- Object 클래스에 정의되어 있는 toString()의 원형은 해당 클래스의 이름과
		  메모리상의 주소값을 출력하게 되어 있다
		...
		- Object 클래스에 정의되어 있는 기본 동작은 두 인스턴스가 같은 인스턴스인지를
		  비교하게끔 만들어져 있다
	...
	public static void main(String[] args) {
		...
		Dog d1 = new Dog("모모", "1234");
		Dog d2 = new Dog("모모", "3456");
		...
		// String은 해쉬코드 메서드가 구현되어 있기 때문에 
		// hashCode()메서드 실행 시 메모리 주소 대신 문자열 값에 기반한 숫자값이 생성된다
		String str1 = new String("abcd");
		String str2 = new String("Hello everyone, My name is Hyejin. Nice to meet you");
		String str3 = new String("Hello everyone, My name is Hyejin Nice to meet you");
