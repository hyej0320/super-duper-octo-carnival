...
public class D04_WrapperClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("5555를 10진법으로 해석한 값: " + str2);
		System.out.println("5555를 2진법으로 해석한 값: " + str3);
		
		// 각 타입과 관련된 상수들
		System.out.println("int타입은 몇 byte? " + Integer.BYTES);
		System.out.println("double타입은 몇 byte? " + Double.BYTES);
		...
		System.out.println("글자인가요? " + Character.isAlphabetic('A'));
		System.out.println("글자인가요? " + Character.isAlphabetic('ㄱ'));
		System.out.println("글자인가요? " + Character.isAlphabetic('+'));
		
		System.out.println("대문자인가요? " + Character.isUpperCase('b'));
		System.out.println("대문자인가요? " + Character.isUpperCase('B'));
		System.out.println("소문자인가요? " + Character.isUpperCase('c'));
		...
		// Character.getType(ch) : 해당 문자의 타입이 무엇인가 - 타입 번호로 나옴
		...
		System.out.println("자바 변수의 맨 앞 문자로 활용할 수 있나요? " 
