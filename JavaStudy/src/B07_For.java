...
public class B07_For {
	...
	/*
	 	...
	 	- 초기값 : for문을 처음 시작하면 단 한 번 실행되는 곳
	 			 주로 반복자(iterator)를 초기화 하는 데에 사용한다
	...
	public static void main(String[] args) {
		...
		// <연습1> byte타입의 모든 값을 최소값부터 최대값까지 출력해보세요
		...
		int a = 10;
		for (; a < 100;) {
			// System.out.println("프로그램이 끝났습니다." + ++a); // 11 ~ 100
			System.out.println("프로그램이 끝났습니다." + a++); // 10 ~ 99
		}
