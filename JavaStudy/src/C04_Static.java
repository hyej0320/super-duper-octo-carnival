...
public class C04_Static {
	...
	/*
		...
		- static 영역의 값은 인스턴스 영역에 활용할 수 있지만 
		  인스턴스 영역의 값은 static 영역에 활용할 수 없다
...
class TrumphCard {
	...
	// 이런 성질의 변수는 인스턴스 값으로 두면 메모리의 공간이 낭비된다
	...
	static void printCardInfo() {
		System.out.print("카드의 너비: " + card_width);
		System.out.print("카드의 높이: " + card_height);
//		System.out.print("카드의 랭크: " + rank);
	}
