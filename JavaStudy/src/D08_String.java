...
public class D08_String {
	...
	public static void main(String[] args) {
		...
		System.out.println(alphabet.substring(8));
...
//		}
		...
		// String.format(format, values...) : 원하는 문자열 만들 때 
		...
		System.out.println(value1 == value2); // 다른 주소값
		System.out.println(value1.equals(value2)); // 같은 값
