...
public class B00_Scanner {
	...
	/*
	 	...
	 	- 새 스캐너를 생성할 때 어느 곳으로부터 입력을 받을 지 설정할 수 있다 
	...
	public static void main(String[] args) {
		...
		//               (다음 정수 입력을 기다리는 기능)
		int num = sc.nextInt();
		System.out.println("입력하신 숫자는 " + num + "입니다."); // 프로그램이 실행 중 - 콘솔 창 숫자 입력 후 프로그램 종료
		
		// next타입()을 쓰고 난 후 남아있는 \n이 문제가 된다면 nextLine()을 사용해 \n을 비워버릴 수 있다
