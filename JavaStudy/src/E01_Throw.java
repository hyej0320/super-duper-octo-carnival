...
public class E01_Throw {
	...
	/*
		...
		- Exception을 상속받는 경우 반드시 예외 처리(try-catch)가 되어야 컴파일이 가능한 중요한 예외가 된다
	...
	public static void method1(int a) 
		...
		if (a % 2 == 1) {
			...
			throw new InputMismatchException("홀수라서 맘에 들지 않음....");
		} else {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("너무 빨라서 걸렸습니다~!");
		}
	}
}
...
class NotEnoughMoneyException extends RuntimeException {
	...
	public NotEnoughMoneyException(int money) {
		super(String.format("돈이 %d원 부족합니다..ㅠ.ㅠ", money));
	}
}
