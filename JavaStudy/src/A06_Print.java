...
public class A06_Print {
	...
	/* 
		...
		3. printf()
			...
			- 출력하고 싶은 문자열의 형식을 먼저 지정한 후 데이터가 들어가야 하는 자리에 데이터를 순서대로 채워서 사용한다
	...
	public static void main(String[] args) {
		...
		System.out.println(); // () 안에 데이터 없으면 줄 바꾸기 가능
		// System.out.print(); () 안에 데이터 채워야 함
		// System.out.printf(); () 안에 데이터 채워야 함, Object - 아무거나 채워라
		
		// printf()를 사용하면 출력하기 편한 경우가 있다,  줄 바꾸기 위해서 \n 사용
		...
		System.out.printf("오늘의 최고 기온: %+3d℃\n", 13);
		System.out.printf("오늘의 최저 기온: %+3d℃\n", -13);
		
		
		System.out.println("--------------------------------------------------");
		
		// %.숫자f로 자릿수를 제한할 때 반올림이 발생한다
