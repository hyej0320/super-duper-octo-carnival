...
public class D06_Peach_T {

	public static void main(String[] args) {
		LinkedList<Peach2> peaches = new LinkedList<>();
		peaches.add(new Peach2(3000, 3.33, "B+", "김가네 농장"));
		peaches.add(new Peach2(2500, 2.43, "A+", "김씨네 농장"));
		peaches.add(new Peach2(1800, 4.01, "A-", "김씨부부네 농장"));
		peaches.add(new Peach2(3300, 5.63, "A-", "김정묵씨네 농장"));
		peaches.add(new Peach2(1900, 4.19, "C+", "김씨네 농장"));
		peaches.add(new Peach2(2300, 3.55, "B", "김씨네 농장"));
		peaches.add(new Peach2(2500, 2.56, "B", "김씨네 농장"));
		peaches.add(new Peach2(2600, 2.56, "B-", "김씨네 농장"));
		...
		Collections.sort(peaches, new Comparator<Peach2>() {
			...
			public int compare(Peach2 p1, Peach2 p2) {
				...
				if (farm1.equals(farm2)) {
					...
					// 두 농장이름 중 더 짧은 길이의 문자열로 반복해야 한다
					...
					// 길이가 더 긴 문자열이 사전상 더 뒤에 있는 문자열이다
		...
		Collections.sort(peaches, new Comparator<Peach2> () {
			...
			public int compare(Peach2 p1, Peach2 p2) {
				...
				// 등급이 모두 길이가 모두 1이거나 2라면 사전순으로 처리할 수 있다
