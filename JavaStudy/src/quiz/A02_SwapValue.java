...
import java.util.Random; //랜덤 기계 작성
...
public class A02_SwapValue {
	...
	public static void main(String[] args) {
		...
		// 코드를 추가해 두 변수의 값을 서로 교환하여 출력해 보세요(다른 곳은 변경 불가능)
		...
		// (1) 
		// a의 값이 사라지는 것을 대비하여 따로 빼놓는다 *backup
		int backUp = a;
		// a에는 b의 값을 대입한다
		a = b;
		...
		int c = ran.nextInt(30);
		int d = ran.nextInt(30);
	
		// 코드를 추가해 두 변수의 값을 서로 교환하여 출력해 보세요(다른 곳은 변경 불가능)
		
		System.out.println("c에 원래 보관된 값: " + c);
		System.out.println("d에 원래 보관된 값: " + d);
		...
		System.out.println("교환 후 c에 보관된 값: " + c);
		System.out.println("교환 후 d에 보관된 값: " + d);
	}
}
